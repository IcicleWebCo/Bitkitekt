  ...
  return (
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory scrollbar-hide bg-slate-950">
      {posts.map((post) => (
        <div
          key={post.id}
          className="min-h-screen w-full snap-start flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative"
        >
            ...
            <article className="bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl p-6 md:p-10 space-y-6">
              ...
              <header className="space-y-4 border-b border-slate-700/50 pb-6">
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  {post.risk_level && (
                    <div className={`flex items-center gap-2 px-4 py-2 rounded-lg border ${riskColors[post.risk_level]}`}>
                      <AlertTriangle className="w-5 h-5" />
                      <span className="font-semibold">{post.risk_level} Risk</span>
                    </div>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-6">
                  ...
                  {post.performance_impact && (
                    <section>
                      <h2 className="text-lg font-semibold text-sky-400 mb-2">Performance Impact</h2>
